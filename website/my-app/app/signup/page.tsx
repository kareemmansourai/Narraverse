...
export default function SignupPage() {
  ...
  const handleGoogleSignup = async () => {
    try {
      await googleLogin();
      toast.success("Welcome to Narraverse!");
      router.push("/");
    } catch (error) {
      if (error instanceof Error) toast.error(error.message);
      else toast.error("Something went wrong. Please try again.");
  ...
  return (
    <div
      className="relative min-h-screen w-full flex items-start justify-end pr-[6vw] overflow-y-auto py-7"
    ...
    >
      ...
      <div
        className="relative z-10 w-[490px] flex flex-col items-center rounded-2xl px-10 py-1 mt-24"
        style={{
      ...
      >
        ...
        >
          Join Narraverse and start crafting your stories.
        </p>
